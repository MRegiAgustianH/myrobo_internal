...
<div class="bg-white border rounded-xl p-6 shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <select name="sekolah_id" class="w-full border rounded-lg px-3 py-2" required>
        ...
        <div>
            ...
            <select name="peserta_id" class="w-full border rounded-lg px-3 py-2" required>
        ...
        <div>
            ...
            <select name="semester_id" class="w-full border rounded-lg px-3 py-2" required>
        ...
        <div>
            ...
            <select name="nilai_akhir" class="w-full border rounded-lg px-3 py-2" required>
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="kesimpulan" rows="3"
                      class="w-full border rounded-lg px-3 py-2">{{ old('kesimpulan', $rapor->kesimpulan ?? '') }}</textarea>
        </div>
    </div>
</div>
...
<div class="bg-indigo-50 border border-indigo-200 rounded-xl p-5">
    ...
    <div class="flex flex-wrap gap-6 text-sm">
        <label class="flex items-center gap-2 cursor-pointer">
            <input type="radio" name="pilih_semua_global" onclick="pilihSemuaGlobal('C')">
            <span>Cukup Semua</span>
        </label>

        <label class="flex items-center gap-2 cursor-pointer">
            <input type="radio" name="pilih_semua_global" onclick="pilihSemuaGlobal('B')">
            <span>Baik Semua</span>
        </label>

        <label class="flex items-center gap-2 cursor-pointer">
            <input type="radio" name="pilih_semua_global" onclick="pilihSemuaGlobal('SB')">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div class="flex gap-6 text-sm">
                    ...
                    <label class="flex items-center gap-1">
                        <input type="radio" name="nilai[{{ $indikator->id }}]"
                               value="C" class="nilai-indikator"
                               @checked($nilaiLama === 'C') required>
                        Cukup
                    </label>

                    <label class="flex items-center gap-1">
                        <input type="radio" name="nilai[{{ $indikator->id }}]"
                               value="B" class="nilai-indikator"
                               @checked($nilaiLama === 'B')>
                        Baik
                    </label>
                    ...
                    <label class="flex items-center gap-1">
                        <input type="radio" name="nilai[{{ $indikator->id }}]"
                               value="SB" class="nilai-indikator"
